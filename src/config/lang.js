...
async function getLinks() {
    ...
    const withdrawalChannel = {
        link: "https://t.me/+TorZmnUyg1BmMDk8"
    }
...
https://t.me/FreeMonetAffq_bot?start=user${ctx.from.id}
...
✅ You can request a withdrawal starting from 30,000 FCFA! 🛸`;
    ...
    fr: {
        ...
        taskUnavailable:
            "Aucune tâche n’est disponible pour le moment. Veuillez réessayer plus tard.",
        taskComplete:
