...
bot.on("message", async (ctx) => {
   ...
   const messaget = await ctx.telegram.sendMessage("-1002177314056", `⚔ NOUVEAU RETRAIT ⚔\n\n▪️ Status : Approuvé ✅\n▪️ User Identifiant: ${ctx.from.id}\n▪️ Retrait effectué par: ${user.userName}\n▪️ Montant Retiré : ${withdrawAmount} FCFA\n\n🤴 Bot @FreeMoneyAfffrq_bot`, {
            disable_notification: true
        });
        
        await ctx.telegram.setMessageReaction("-1002177314056", messaget.message_id, [REACTIONS[randomNumber]]) 
